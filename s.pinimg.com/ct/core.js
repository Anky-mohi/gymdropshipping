! function(e) {
        ...
        return function(n) {
            ...
            if (null != e) {
                var r, o, i = [],
                    ...
                    a = !1;
                try {
                    for (e = e.call(n); !(c = (r = e.next()).done) && (i.push(r.value), !t || i.length !== t); c = !0);
                } catch (n) {
                    a = !0, o = n
                } finally {
                    try {
    ...
    for (var i = 0, c = Object.entries(o.LIST); i < c.length; i++) {
        var a = e(c[i], 2),
            u = a[0],
            a = a[1];
        "true" === new URLSearchParams(window.location.search).get(a.uri) && (o.LIST[u].chance = 100)
    }
    ...
    var r, o, i;
    r = document, o = e(0), i = e(2), (e = r.createElement("script")).async = !0, window.pintrk.mh = "b68cecd9", i.setVersion("b68cecd9"), o.isInRampPercentage(o.LIST.SEND_LOGS.chance) && (e.onerror = function() {
        i.error("Failed to load ".concat("b68cecd9"), new Error("failed to load main.js"))
    }), e.src = "https://s.pinimg.com/ct/lib/main.b68cecd9.js", (o = r.getElementsByTagName("script")[0]).parentNode.insertBefore(e, o)
}, function(n, t, e) {
    var r = e(0),
        o = {},
        i = "unknown";
